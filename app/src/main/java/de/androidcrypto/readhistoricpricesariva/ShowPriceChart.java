    ...
    private void loadCsvFile(String directory, String filename) {
        ...
        try {
            ...
            for (String[] arrays : result) {
                ...
                String arClose = arrays[4];

                // convert the date in yyyy-mm-tt format to a float value
                DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
                Date dateUnix = null;
                try {
                    dateUnix = dateFormat.parse(arDate);
                ...
                // convert string with comma to point for decimals separator
                arClose = arClose.replace(",", ".");
